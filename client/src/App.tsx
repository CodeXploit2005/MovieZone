...
function App() {
  ...
  return (
    <div className={`flex flex-col min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-[#0a0a0a] text-white' : 'bg-white text-dark'}`}>
      {isAdminPath ? <AdminNavbar /> : <Navbar />}
      <main className={`flex-grow ${isAdminPath ? 'pt-20' : 'pt-16'}`}>
