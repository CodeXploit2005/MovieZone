...
const movieService = {
  ...
  getMovieById: async (id, language, type = 'movie') => {
    const res = await axios.get(`${API_URL}/${id}`, { params: { language, type } });
    return res.data;
  },
  
  searchMovies: async (query, page, type, language) => {
  ...
  getPopularMovies: async (page, language, type = 'movie') => {
  ...
  getTrendingMovies: async (page, language, type = 'movie') => {
  ...
  getTopRatedMovies: async (page, language, type = 'movie') => {
  ...
  getUpcomingMovies: async (page, language) => {
