...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      ...
      const storedUser = JSON.parse(localStorage.getItem('moviezone_user'));
            ...
            <div className="relative z-20">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="flex items-center justify-between px-2">
                  ...
                  <Link to="/forgot-password" size="sm" className="text-xs font-bold text-neutral-500 hover:text-primary transition-colors uppercase tracking-widest">
                    {t('forgot_password')}
                  </Link>
                </div>
