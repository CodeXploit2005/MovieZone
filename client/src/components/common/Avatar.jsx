...
const Avatar = ({ src, alt, size = 40, className, onClick }) => {
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(false);

  const defaultAvatar = 'https://res.cloudinary.com/dzp7f8vjx/image/upload/v1715764000/moviezone/default-avatar_u9z5q2.png'; // Placeholder or local asset
