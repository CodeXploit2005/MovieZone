...
const SupportChat = () => {
  ...
  return (
    <div className="fixed bottom-24 right-8 z-[9999] support-chat-container">
      <AnimatePresence>
            ...
            <AnimatePresence>
              {isOpen && (
                <motion.div
                  ...
                  className={`absolute bottom-16 right-0 w-[300px] sm:w-[340px] h-[450px] rounded-[1.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col border ${
                    theme === 'dark' 
            ...
            >
              ...
              {!isOpen && (
                <span className="absolute top-2 right-2 flex h-2.5 w-2.5">
                  ...
                  <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-green-500 border border-primary"></span>
                </span>
              )}
            </motion.button>
          </div>
